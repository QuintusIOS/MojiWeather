...
-(SEL)getSetterSelWithAttibuteName:(NSString*)attributeName{
    ...
    NSString *capital = [[attributeName substringToIndex:1] uppercaseString];// "N"
...
//                              };
    ...
    for (NSString *attributeName in attrbuteNameArray) {
        //通过属性名获得set方法
        // sel = [self getSetterSelWithAttibuteName:@"name"];
        SEL sel = [self getSetterSelWithAttibuteName:attributeName];// setName
